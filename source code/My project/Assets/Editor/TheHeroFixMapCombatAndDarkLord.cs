...
public class TheHeroFixMapCombatAndDarkLord : EditorWindow
{
    ...
    private static void FixMapScene()
    {
        ...
        if (darkLord != null)
        {
            ...
            darkLord.enemyArmy = new List<THArmyUnit> {
                new THArmyUnit { id = "dark_lord", name = "Dark Lord", count = 1, hpPerUnit = 250, attack = 20, defense = 10, initiative = 8 },
                new THArmyUnit { id = "unit_orc", name = "Orc Elite", count = 12, hpPerUnit = 40, attack = 7, defense = 3, initiative = 5 }
            };
        }
    ...
    private static void AddGuard(THMapObject res, string name, string id, string spritePath, int g, int s, int exp)
    {
        ...
        mo.enemyArmy = new List<THArmyUnit> {
            new THArmyUnit { id = "unit_orc", name = "Orc", count = 8, hpPerUnit = 30, attack = 5, defense = 2, initiative = 4 }
        };
