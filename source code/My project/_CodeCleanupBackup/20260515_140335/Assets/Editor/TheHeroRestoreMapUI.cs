...
namespace TheHero.Editor
{
    public static class TheHeroRestoreMapUI
    {
        ...
        public static void RestoreOpenMapUI(bool saveScene)
        {
            ...
            bool validationPassed = TheHeroValidateMapUI.ValidateOpenMapUI(false);
        ...
        private static void ConnectRuntime(Canvas canvas, MapUIRefs refs)
        {
            ...
            var controller = Object.FindObjectsByType<THMapController>(FindObjectsInactive.Include, FindObjectsSortMode.None).FirstOrDefault();
            if (controller != null)
            {
